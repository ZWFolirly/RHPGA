...
#ifndef PARALLELHGA_GREEDYPHASHGENETIC_H
#define PARALLELHGA_GREEDYPHASHGENETIC_H
...
public:
    ...
    iDistribution u_pop;
    iDistribution u_row;
    GreedyPHashGenetic(Graph _graph,string _filename);
...
#endif //PARALLELHGA_GREEDYPHASHGENETIC_H
